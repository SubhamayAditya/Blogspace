                ...
                <div class="card edit-card shadow-sm p-4">
                    ...
                    <form method="POST" action="{{ route('user.blog.update', $blog->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                <img src="{{ asset('uploads/' . $blog->image) }}" class="img-fluid image-preview w-100">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="editor" class="form-control" rows="8">{!! old('description', $blog->description) !!}</textarea>
                        </div>

                        {{-- ACTIONS --}}
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('user.blog.show', $blog->id) }}" class="btn btn-outline-secondary">
