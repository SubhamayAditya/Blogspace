    ...
    {{-- <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <button class="btn btn-primary ms-3 text-white"><i class="fas fa-pen"></i> <a href="{{ route('blog.write') }}">Write</a></button>
            </div>
        </div>
    </nav> --}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <h5 class="fw-bold mb-3">BlogSpace</h5>
                    <p>Your platform for sharing stories and connecting with readers worldwide.</p>
                </div>
                <div class="col-md-4 mb-4">
                    <h5 class="fw-bold mb-3">Quick Links</h5>
                    <ul class="list-unstyled">
                        <li><a href="{{ route('blog.about') }}" class="text-white-50 text-decoration-none">About Us</a>
                        </li>
                        ...
                        <li><a href="{{ route('blog.contact') }}" class="text-white-50 text-decoration-none">Contact</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-4 mb-4">
