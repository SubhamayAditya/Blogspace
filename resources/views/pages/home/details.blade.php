        ...
        function reactBlog(blogId, type) {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    document.getElementById(`like-btn-${blogId}`).classList.toggle('active', type === 'like' && data
                        .userReaction === 'like');
                    document.getElementById(`dislike-btn-${blogId}`).classList.toggle('active', type === 'dislike' &&
