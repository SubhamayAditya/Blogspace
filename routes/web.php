...
Route::middleware(['auth'])->group(function () {
    Route::get('/admin/categories', [AuthController::class, 'categories'])->name('admin.categories');
    Route::post('/admin/categories', [AuthController::class, 'storeCategory'])->name('admin.categories.store');
    Route::delete('/admin/categories/{id}', [AuthController::class, 'deleteCategory'])->name('admin.categories.delete');
});
